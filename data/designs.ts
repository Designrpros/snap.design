import type { DesignEntry, Category, SortOption } from "@/types/design";
...
export const sortOptions: SortOption[] = ["trending", "popular", "newest"];
...
export function getSortedDesigns(
  designs: DesignEntry[],
  sort?: string
): DesignEntry[] {
  if (!sort) return designs;
  return [...designs].sort((a, b) => {
    const aVal = a[sort as keyof Pick<DesignEntry, "trending" | "popular" | "newest">] ?? 0;
    const bVal = b[sort as keyof Pick<DesignEntry, "trending" | "popular" | "newest">] ?? 0;
...
export const designs: DesignEntry[] = [
  {
    ...
    description:
      "A project management tool with a dark, minimalist interface and refined typography.",
    featured: true,
    trending: 98,
    popular: 245,
    newest: 12,
      ...
      shadows: [
        {
          name: "Card",
          value:
            "0px 2px 8px rgba(0,0,0,0.12), 0px 0px 1px rgba(0,0,0,0.2)",
        },
        {
          name: "Dropdown",
          value:
            "0px 8px 24px rgba(0,0,0,0.2), 0px 0px 1px rgba(0,0,0,0.3)",
        },
        {
          name: "Modal",
          value:
            "0px 16px 48px rgba(0,0,0,0.25), 0px 0px 1px rgba(0,0,0,0.3)",
        },
      ],
      radii: [
...
- Subtle glass effects on overlays`,
  },
  {
    ...
    description:
      "A developer platform with clean geometry, geometric precision and a monochrome palette.",
    featured: false,
    trending: 85,
    popular: 190,
    newest: 8,
      ...
      shadows: [
        {
          name: "Subtle",
          value:
            "0px 2px 8px rgba(0,0,0,0.08), 0px 0px 1px rgba(0,0,0,0.1)",
        },
        {
          name: "Elevated",
          value:
            "0px 8px 32px rgba(0,0,0,0.12), 0px 0px 1px rgba(0,0,0,0.15)",
        },
        {
          name: "Overlay",
          value:
            "0px 16px 64px rgba(0,0,0,0.2), 0px 0px 2px rgba(0,0,0,0.25)",
        },
      ],
      radii: [
        { name: "Button", value: "6px", px: 6 },
...
- Generous whitespace with large typography scale`,
  },
  {
    ...
    description:
      "A payment platform with refined gradients, glass surfaces, and elegant UI elements.",
    featured: false,
    trending: 72,
    popular: 210,
    newest: 5,
      ...
      shadows: [
        {
          name: "Card",
          value:
            "0px 2px 12px rgba(0,0,0,0.04), 0px 0px 1px rgba(0,0,0,0.08)",
        },
        {
          name: "Elevated",
          value:
            "0px 8px 32px rgba(0,0,0,0.06), 0px 0px 2px rgba(0,0,0,0.1)",
        },
        {
          name: "Nav",
          value:
            "0px 1px 4px rgba(0,0,0,0.04), 0px 0px 1px rgba(0,0,0,0.06)",
        },
      ],
      radii: [
        { name: "Button", value: "6px", px: 6 },
...
- Generous use of whitespace, minimalist UI chrome`,
  },
  {
    ...
    description:
      "A productivity tool with a distinctive warm gradient aesthetic and rounded, friendly UI.",
    featured: false,
    trending: 90,
    popular: 175,
    newest: 15,
      ...
      shadows: [
        {
          name: "Subtle",
          value:
            "0px 2px 12px rgba(0,0,0,0.04), 0px 0px 1px rgba(0,0,0,0.06)",
        },
        {
          name: "Card",
          value:
            "0px 4px 20px rgba(0,0,0,0.06), 0px 0px 2px rgba(0,0,0,0.08)",
        },
        {
          name: "Elevated",
          value:
            "0px 12px 40px rgba(0,0,0,0.08), 0px 0px 3px rgba(0,0,0,0.1)",
        },
      ],
      radii: [
...
- Apple-inspired minimalism with Raycast's unique warmth`,
  },
  {
    ...
    iframeUrl: "https://www.shopify.com",
    screenshot: "/screenshots/shopify-commerce.png",
    description:
      "An e-commerce platform with a vibrant green brand color and clean, conversion-focused design.",
    featured: false,
    trending: 65,
    popular: 155,
    newest: 3,
    designTokens: {
      colors: [
        ...
        },
        {
          name: "Accent Light",
          hex: "#95c98f",
          cssVariable: "--color-accent-light",
        },
        {
          name: "Dark Surface",
          hex: "#002b1f",
          cssVariable: "--color-dark-surface",
        },
      ],
      typography: [
        {
      ...
      shadows: [
        {
          name: "Card",
          value:
            "0px 2px 8px rgba(0,0,0,0.04), 0px 0px 1px rgba(0,0,0,0.06)",
        },
        {
          name: "Elevated",
          value:
            "0px 8px 32px rgba(0,0,0,0.06), 0px 0px 2px rgba(0,0,0,0.08)",
        },
        {
          name: "Dark Card",
          value:
            "0px 4px 20px rgba(0,0,0,0.15), 0px 0px 2px rgba(0,0,0,0.2)",
        },
      ],
      radii: [
    ...
    designMarkdown: `# Shopify Design System
...
:root {
  ...
  --color-primary: #097353;
  --color-text-primary: #1a1a1a;
  --color-text-secondary: #6b7177;
  --color-border: #dadedb;
  --color-accent-light: #95c98f;
  --color-dark-surface: #002b1f;
}
\`\`\`

## Typography
\`\`\`css
--font-hero: 700 56px/1.05 "Shopify Sans", sans-serif;
--font-heading: 700 36px/1.15 "Shopify Sans", sans-serif;
--font-subheading: 500 20px/1.3 "Shopify Sans", sans-serif;
--font-body: 400 16px/1.55 "Shopify Sans", sans-serif;
--font-ui-label: 600 14px/1.3 "Shopify Sans", sans-serif;
\`\`\`
...
## Usage Notes
- Deep green (#097353) is the hero brand color
- Light green surface (#f1f8f5) for subtle environmental cues
- Dark mode sections with deep forest green (#002b1f)
- Trust-building, human-centered design language`,
  },
  {
    id: "apple-design",
    title: "Apple",
    ...
    description:
      "Consumer electronics with iconic minimalist design, dramatic product photography and precise typography.",
    featured: false,
    trending: 78,
    popular: 230,
    newest: 10,
    designTokens: {
      ...
      shadows: [
        ...
        },
        {
          name: "Nav",
          value:
            "0px 1px 4px rgba(0,0,0,0.03), 0px 0px 1px rgba(0,0,0,0.05)",
        },
        {
          name: "Button",
          value:
            "0px 2px 8px rgba(0,0,0,0.06), 0px 0px 1px rgba(0,0,0,0.08)",
        },
      ],
      radii: [

...
export function Input({ icon = false, insetAction, className, ...props }: InputProps) {
  return (
    <div className="relative w-full max-w-xl">
      {icon && (
        <svg
          className="absolute left-6 top-1/2 -translate-y-1/2 text-slate-gray pointer-events-none"
          width="20"
          height="20"
          viewBox="0 0 16 16"
          fill="none"

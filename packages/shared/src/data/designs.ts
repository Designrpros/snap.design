...
- Apple-inspired minimalism with Raycast's unique warmth`,
  },
  {
    ...
    screenshot: "",
    description:
      "Warm ivory software studio with brushed metallic accents, dark editor panels, and smooth motion design.",
    featured: false,
    trending: 92,
    popular: 210,
    newest: 1,
    designTokens: {
      ...
      shadows: [
        ...
        },
        {
          name: "Elevated",
          value:
            "0px 8px 30px rgba(0,0,0,0.06), 0px 0px 2px rgba(0,0,0,0.04)",
        },
        {
          name: "Glow",
          value:
            "0px 0px 20px rgba(108,92,231,0.15)",
        },
      ],
      radii: [
